...
from res2net_ import Res2Net, ResNet, _BatchNorm, build_norm_layer
...
class CBNet(CBNetBase):
    ...
    def __init__(self,
        ...
        for cb_idx in range(self.cb_num_modules):
            ...
            # print(cb_module.__dict__.keys())
            # print(cb_module.__dict__['res_layers'])
            if cb_idx > 0:
        ...
        # print(self.out_indices, self.num_layers)
